export default function TutorialLanguageLoading() {
  return (
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex-1">
              ...
              {/* Title Skeleton */}
              <div className="mb-2 h-12 w-64 animate-pulse rounded-lg bg-white/10" />

              {/* Description Skeleton */}
              <div className="h-6 w-96 animate-pulse rounded bg-sky-700/50" />
            </div>
          </div>
        </div>
      </div>
          ...
          {[1, 2, 3, 4, 5, 6].map((i) => (
            ...
            >
              ...
              <div className="border-b border-slate-700 bg-slate-800/50 p-4">
                {/* Badge Skeleton */}
                <div className="mb-3 h-6 w-24 animate-pulse rounded-full bg-slate-700/50" />
