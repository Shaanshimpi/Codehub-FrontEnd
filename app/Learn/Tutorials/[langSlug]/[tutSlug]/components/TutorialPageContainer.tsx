...
import TutorialCodePlayground from "./playground/TutorialCodePlayground"
    ...
    <main className="min-h-screen bg-gray-50 dark:bg-gray-900" role="main">
      ...
      <div className="mx-auto max-w-7xl px-2 py-3 sm:px-4 sm:py-6 lg:px-8">
        <div
          ...
          role="presentation"
        >
          {/* Mobile Sidebar Toggle - Floating Action Button - Hidden when playground is open */}
          {!showPlayground && (
            <button
          ...
          {/* Enhanced Mobile Header - Hidden when playground is open */}
          {!showPlayground && (
          ...
          {/* Mobile Slide-out Sidebar - Hidden when playground is open */}
          {!showPlayground && isSidebarOpen && (
            <>
              {/* Backdrop */}
              <button
                type="button"
          ...
          {/* Desktop Sidebar - Hidden when playground is open */}
          {!showPlayground && (
            <aside
                    ...
                    {tutorial.reference ? (
                      <div className="-mx-3 rounded-xl border border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-800 sm:-mx-6 lg:-mx-8">
                        ...
                        >
                            ...
                            <div className="space-y-6">
                              ...
                              tutorial.reference.examples.length > 0 ? (
                                ...
                                <div className="py-12 text-center">
                                  ...
                                  />
                                  <p className="text-gray-500 dark:text-gray-400">
                                    No code examples available for this
                                    tutorial.
                                  </p>
                                </div>
                              )}
                                ...
                                <div className="py-12 text-center">
                                  ...
                                  <div>
                                    ...
                                    <p className="mt-2 text-sm text-gray-400 dark:text-gray-500">
                                      This means it&apos;s well-structured or
                                      new content!
                                    </p>
                                  </div>
                                </div>
                          ...
                          {/* Playground Button in Reference Section */}
                          <div className="mt-12">
                            <PlaygroundButton
                              onClick={() => {
                      ...
                      <div className="py-12 text-center">
                        ...
                        {/* Playground Button for No Content */}
                        <div className="mt-8">
                          <PlaygroundButton
                            onClick={() => {
                              setShowPlayground(true)
                    ...
                    <div className="p-4 sm:p-6 lg:p-8">
                      {currentLesson ? (
                        <div>
                          ...
                          {/* Playground Button - Show for all lesson types when playground is closed */}
                          {currentLesson && (
                            <div className="mt-8">
                              <PlaygroundButton
                                onClick={() => {
