...
const TutorialHeader = ({ tutorial, language }: TutorialHeaderProps) => {
  const pathname = usePathname()

  const getParentPath = () => {
    // Navigate back to language tutorials page
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-xl text-sky-100 dark:text-sky-200">
              Learn through comprehensive lessons and interactive content
            </p>
          </div>
        </div>
      </div>
