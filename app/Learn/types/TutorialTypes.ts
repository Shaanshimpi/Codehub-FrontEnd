...
export interface FillInTheBlankData {
  questions: {
    id: string
    scenario: string // MAKE REQUIRED: Required by API schema
    code: string
    ...
    hints: string[] // MAKE REQUIRED: Required by API schema
    solution: {
      // MAKE REQUIRED: Required by API schema
      completeCode: string
      explanation: string
      diagram_data?: any // JSON objects that convert to Mermaid
    }
    difficulty: 1 | 2 | 3 // MAKE REQUIRED: Required by API schema
  }[]
}
...
export interface CodeRearrangeData {
  questions: {
    id: string
    scenario: string // MAKE REQUIRED: Required by API schema
    targetCode: string // MAKE REQUIRED: Required by API schema
    diagram_data?: any // JSON objects that convert to Mermaid
    blocks: {
      id: string
      code: string
...
export interface ConceptLessonData {
  ...
  diagram_data?: any // JSON objects that convert to Mermaid
  commonMistakes: string[] // MAKE REQUIRED: Per solution "add"
  bestPractices: string[] // MAKE REQUIRED: Per solution "add"
}
...
export interface TutorialLesson {
  ...
  type: LessonType
  order: number
  learningObjectives: string[] // MAKE REQUIRED: Required by API schema
  keyTopics: string[] // MAKE REQUIRED: Required by API schema
  data:
    | MCQOption[]
    | FillInTheBlankData
    | CodeRearrangeData
...
// MCQ Content wrapper interface for lesson data
...
export interface TutorialData {
  ...
  description: string
  videoUrl?: string
  learningObjectives: string[] // ADD: Required by API schema
  keyTopics: string[]
  difficulty: 1 | 2 | 3
  lessons: {
    id: string
  ...
  tags: string[]
  programmingLanguage?: string
  reference: ReferenceContent // MAKE REQUIRED: Required by API schema
  // Form-only fields (not generated by AI)
  index?: number
  isLocked?: boolean
}
